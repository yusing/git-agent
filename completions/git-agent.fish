...
complete -c git-agent -n '__git_agent_using_command review' -l dry-run -d 'Emit deterministic provider events without a provider request'
complete -c git-agent -n '__git_agent_using_command review' -l orchestration-artifact -r -d 'Read helper-authorized orchestration artifact manifest'
...
complete -c git-agent -n '__git_agent_using_command simplify' -l dry-run -d 'Emit deterministic provider events without a provider request'
complete -c git-agent -n '__git_agent_using_command simplify' -l orchestration-artifact -r -d 'Read helper-authorized orchestration artifact manifest'
...
complete -c git-agent -n '__git_agent_using_command search' -l min-score -r -d 'Minimum final hybrid score'
complete -c git-agent -n '__git_agent_using_command search' -l limit -r -d 'Maximum results'
complete -c git-agent -n '__git_agent_using_command search' -l format -r -a 'json brief text tree' -d 'Output format'
